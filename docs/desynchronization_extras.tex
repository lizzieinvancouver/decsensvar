...
\ref{tab:mean_bloom_bins}--\ref{tab:sd_bloom_bins} ... with the GAM.  
...
variability has greater influence on timing. 
\section{References}\label{references}




% Move to table captions etc.
 Table \ref{tab:mean_bloom_bins}
...
(chosen based on the quartiles of \(\alpha\) and \(\beta\)). 
