...
Using a very large dataset of lilacs from across the United States (ADDCITES), we estimated the shift in variance independent of the changing mean temperature using a general additive model (GAM), and found increasing variance as February temperatures pass 12 \degree C. 
...
\item General additive model (GAM) results using lilac bloom data from across the United States. 
\end{enumerate}
